...
printf "${C}----                                                          ${C}----\n${NC}"
printf "${C}----         ${NC}Вы действительно хотите использовать,${C}            ----\n${NC}"
printf "${C}---- ${NC}старую версию системы, которая больше не поддерживается?${C} ----\n${NC}"
printf "${C}----                                                          ${C}----\n${NC}"
printf "${C}----              ${G}Команда установки новой версии:${C}             ----\n${NC}"
printf "${C}----             ${G}bash <(wget cinemapress.sh -qO-)${C}             ----\n${NC}"
printf "${C}----                                                          ${C}----\n${NC}"
printf "${C}------------------------------------------------------------------\n${NC}"
printf "\n${NC}"
if [ ${1} ]
...
echo "Использовать старую версию? [ДА/нет] : ${YES}"
else
read -e -p 'Использовать старую версию? [ДА/нет] : ' YES
YES=`echo ${YES} | iconv -c -t UTF-8`
fi
printf "\n${NC}"
